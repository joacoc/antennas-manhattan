 ...
 * @param antennaName 
 */
const findHelperAntennas = (antennaName): Promise<Array<{ antenna_id: number }>> => {
        ...
        try {
            ...
            if (performance < 4.75) {
                if (antennaCounter > 5 && !alreadyImprovingSet.has(antennaId)) {
                    ...
                    performanceMapCounter.set(antennaId, typeof antennaCounter === "number" ? (antennaCounter + 1) : 1);
                }
            } else {
